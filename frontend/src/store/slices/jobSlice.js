...
export const fetchJobs =
  (city, skill, searchKeyword = "") =>
  async (dispatch) => {
    try {
      dispatch(jobSlice.actions.requestForAllJobs());
      let link =
        "https://job-portal-backend-s3b6.onrender.com/api/v1/job/getall?";
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portal-backend-s3b6.onrender.com/api/v1/job/get/${jobId}`,
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-portal-backend-s3b6.onrender.com/api/v1/job/post`,
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portal-backend-s3b6.onrender.com/api/v1/job/getmyjobs`,
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-portal-backend-s3b6.onrender.com/api/v1/job/delete/${id}`,
      { withCredentials: true }
    );
